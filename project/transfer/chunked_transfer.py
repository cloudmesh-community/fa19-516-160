...
config = Config()
credentials=config['cloudmesh.storage.google.credentials']
CLIENT_SECRETS_FILE = 'client_secrets.json' # Read how do you get this file and find how do you put your credentials in this

# File where we will store authentication credentials after acquiring them.
CREDENTIALS_FILE = 'credentials.json'  # Change this to Yaml
...
def get_authenticated_service(scope):
  ...
  flow = flow_from_clientsecrets(CLIENT_SECRETS_FILE, scope=scope,
                                 message=MISSING_CLIENT_SECRETS_MESSAGE)     # Imp

  credential_storage = CredentialStorage(CREDENTIALS_FILE)  # IMP
